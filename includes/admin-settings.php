...
class GeolocationFormAutofillPlugin {
    ...
    public function admin_page() {
        ...
        ?>
        <div class="wrap">
            <h1>Geolocation Form Autofill Plugin</h1>
                ...
                <table class="form-table">
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <label for="geolocation_form_autofill_enable">JavaScript-Code aktivieren/deaktivieren</label>
                        </td>
                    </tr>
                    <tr valign="top">
                        ...
                        <td>
                            <select name="geolocation_form_autofill_location">
                                <option value="header" <?php selected(get_option('geolocation_form_autofill_location'), 'header'); ?>>Im Header der Seite</option>
                                <option value="shortcode" <?php selected(get_option('geolocation_form_autofill_location'), 'shortcode'); ?>>Mit Shortcode gezielt auf Seite</option>
                            </select>
                        </td>
                    </tr>
                </table>
            ...
            <h2>Anleitung</h2>
            <p>Mit diesem Plugin können Sie automatisch Stadt- und Postleitzahlinformationen in ein Formularfeld eintragen, basierend auf der Geolocation des Benutzers.</p>
